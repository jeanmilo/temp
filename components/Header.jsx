      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative flex justify-between items-center">
          <div className="flex-shrink-0 absolute left-0">
            <Link href="#home" className="text-accent font-bold text-md sm:text-md md:text-lg text-decoration-line: none">
            ...
            <ul className="flex space-x-4 md:space-x-8">
              {navItems.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-[75%] sm:text-sm md:text-md hover:text-saccent"
